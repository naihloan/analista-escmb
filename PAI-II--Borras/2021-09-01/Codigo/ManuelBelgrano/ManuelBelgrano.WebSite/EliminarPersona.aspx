...
<body>
    <form id="form1" runat="server" onsubmit="javascript return window.confirm('Confirma Eliminar?');">
        ...
        <div>
            ...
            <input type="number" id="Edad" name="Edad" min="1" max="150" value="<%= Request.QueryString["Edad"] %>" />
        </div>
        <div>
            <input type="submit" />
        </div>
